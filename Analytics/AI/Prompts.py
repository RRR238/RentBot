...
- NEGATÍVNE VYMEDZENIA: Konkrétne vylúčenia VŽDY ignoruj — môžu sa týkať čohokoľvek: lokality, dispozície, vybavenia, okolia, susedov alebo čohokoľvek iného. Ak negatívne vyjadrenie implikuje pozitívnu požiadavku na charakter prostredia, zahrň ju v pozitívnej forme (napr. "nechce hluk" → "tiché prostredie"). Ak neimplikuje pozitívnu vlastnosť, ignoruj ho.
- POZITÍVNE PREFERENCIE ktoré patria do 'ostatne_preferencie': balkón, parkovanie, klimatizácia, blízkosť parku, občianska vybavenosť, MHD, škola v okolí, pet friendly, tiché prostredie a podobne. Ak ich používateľ explicitne uviedol, VŽDY ich zahrň.
- VYBAVENIE: zahrň IBA nadštandardné vybavenie (klimatizácia, podlahové kúrenie, sauna, krb, smart home). NIKDY nezahrňuj: práčka, chladnička, sporák, umývačka, mikrovlnka, "plne vybavená kuchyňa", "klasická vybavenosť", "bežné vybavenie" a žiadne iné štandardné spotrebiče.
- DISPOZÍCIA: zahrň IBA neštandardné požiadavky (samostatná kuchyňa, pracovňa, šatník). NIKDY nezahrňuj: "kuchyňa spojená s obývačkou", "otvorená kuchyňa", "open plan" — to je štandard väčšiny bytov.
...
- Ak nie je žiadna charakteristika vhodná do nadpisu, vráť prázdny reťazec. Aj všeobecné charakteristiky ako "tichá lokalita", "pokojné prostredie", "blízko MHD" sú vhodné do nadpisu.
